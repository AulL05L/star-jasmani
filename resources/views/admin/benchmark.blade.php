...
<div class="min-h-screen bg-black text-white p-6 lg:p-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 text-sm mt-1">Tabel konversi skor per item tes fisik — sumber: data resmi pelatih</p>
    </div>

    {{-- Tab Gender --}}
    <div class="flex gap-2 mb-6">
        <button onclick="showGender('putra')" id="tab-putra"
            class="px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-red-800 text-white">
            Putra (Pull-Up)
        </button>
        <button onclick="showGender('putri')" id="tab-putri"
            class="px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-gray-900 border border-gray-800 text-gray-400 hover:text-white">
            Putri (Chin-Up)
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
            <div class="px-5 py-3 border-b border-gray-800 flex items-center gap-2">
                <i class="fa-solid fa-person-running text-red-500 text-xs"></i>
                <h2 class="text-white font-bold uppercase tracking-widest text-xs">Lari 12 Menit</h2>
                ...
                <table class="w-full text-xs">
                    <thead class="sticky top-0">
                        <tr class="bg-gray-900 text-gray-500 uppercase tracking-widest text-[10px]">
                            <th class="text-left px-4 py-2" id="lari-col-putra">Jarak (m) — Putra</th>
                            <th class="text-right px-4 py-2">Skor</th>
                            <th class="text-left px-4 py-2" id="lari-col-putri" style="display:none">Jarak (m) — Putri</th>
                        </tr>
                    </thead>
                    <tbody id="tbl-lari-putra" class="divide-y divide-gray-900">
                        ...
                        <tr class="hover:bg-gray-900/50">
                            <td class="px-4 py-1.5 text-gray-300">{{ number_format($meter) }}</td>
                            <td class="px-4 py-1.5 text-right font-black
                                {{ $skor >= 80 ? 'text-green-400' : ($skor >= 70 ? 'text-blue-400' : ($skor >= 60 ? 'text-yellow-400' : 'text-gray-500')) }}">
                                {{ $skor }}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tbody id="tbl-lari-putri" class="divide-y divide-gray-900" style="display:none">
        ...
        <div class="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
            <div class="px-5 py-3 border-b border-gray-800 flex items-center gap-2">
                ...
                <h2 class="text-white font-bold uppercase tracking-widest text-xs">Push-Up</h2>
            ...
            <div class="overflow-y-auto max-h-96">
                <table class="w-full text-xs">
                    <thead class="sticky top-0">
                        <tr class="bg-gray-900 text-gray-500 uppercase tracking-widest text-[10px]">
                            <th class="text-left px-4 py-2">Repetisi</th>
                            <th class="text-right px-4 py-2">Skor</th>
                        </tr>
                    </thead>
                    <tbody id="tbl-pushup-putra" class="divide-y divide-gray-900">
                        ...
                        <tr class="hover:bg-gray-900/50">
                            <td class="px-4 py-1.5 text-gray-300">{{ $reps }} reps</td>
                            <td class="px-4 py-1.5 text-right font-black {{ $skor >= 80 ? 'text-green-400' : ($skor >= 70 ? 'text-blue-400' : ($skor >= 60 ? 'text-yellow-400' : 'text-gray-500')) }}">{{ $skor }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tbody id="tbl-pushup-putri" class="divide-y divide-gray-900" style="display:none">
                        @php $pushupPutri = [[50,100],[49,96],[48,93],[47,91],[46,87],[45,84],[44,82],[43,78],[42,75],[41,73],[40,69],[39,66],[38,64],[37,60],[36,57],[35,55],[34,51],[33,48],[32,46],[31,42],[30,39],[29,37],[28,33],[27,30],[26,26],[25,24],[24,20],[23,19],[22,15],[21,12],[20,10],[19,9],[18,8],[17,7],[16,6],[15,6],[14,5],[13,5],[12,4],[11,4],[10,3],[9,3],[8,3],[7,2],[6,2],[5,2],[4,1],[3,1],[2,1],[1,1]]; @endphp
        ...
        <div class="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
            <div class="px-5 py-3 border-b border-gray-800 flex items-center gap-2">
                <i class="fa-solid fa-child-reaching text-red-500 text-xs"></i>
                <h2 class="text-white font-bold uppercase tracking-widest text-xs">Sit-Up</h2>
                <span class="ml-auto text-gray-600 text-[10px]">Reps → Skor</span>
            </div>
            <div class="overflow-y-auto max-h-96">
                <table class="w-full text-xs">
                    ...
                    <tbody id="tbl-situp-putra" class="divide-y divide-gray-900">
                        @php $situpPutra = [[40,100],[39,96],[38,92],[37,88],[36,84],[35,80],[34,76],[33,72],[32,68],[31,64],[30,60],[29,56],[28,52],[27,48],[26,44],[25,41],[24,38],[23,35],[22,32],[21,30],[20,28],[19,26],[18,24],[17,22],[16,20],[15,18],[14,16],[13,14],[12,12],[11,10],[10,8],[9,6],[8,4]]; @endphp
                    ...
                    <tbody id="tbl-situp-putri" class="divide-y divide-gray-900" style="display:none">
                        @php $situpPutri = [[50,100],[49,97],[48,93],[47,91],[46,87],[45,84],[44,82],[43,78],[42,75],[41,73],[40,69],[39,66],[38,64],[37,60],[36,57],[35,55],[34,51],[33,48],[32,46],[31,42],[30,39],[29,37],[28,33],[27,30],[26,26],[25,24],[24,20],[23,19],[22,15],[21,12],[20,10],[19,9],[18,8],[17,7],[16,6],[15,6],[14,5],[13,5],[12,4],[11,4],[10,3]]; @endphp
        ...
        <div class="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
            <div class="px-5 py-3 border-b border-gray-800 flex items-center gap-2">
                <i class="fa-solid fa-arrow-up-from-bracket text-red-500 text-xs"></i>
                <h2 id="pullchin-title" class="text-white font-bold uppercase tracking-widest text-xs">Pull-Up</h2>
                <span class="ml-auto text-gray-600 text-[10px]">Reps → Skor</span>
            </div>
            <div class="overflow-y-auto max-h-96">
                <table class="w-full text-xs">
                    ...
                    <tbody id="tbl-pullup-putra" class="divide-y divide-gray-900">
                    ...
                    <tbody id="tbl-pullup-putri" class="divide-y divide-gray-900" style="display:none">
        ...
        <div class="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
            <div class="px-5 py-3 border-b border-gray-800 flex items-center gap-2">
                <i class="fa-solid fa-shuffle text-red-500 text-xs"></i>
                <h2 class="text-white font-bold uppercase tracking-widest text-xs">Shuttle Run</h2>
        ...
        <div class="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
            <div class="px-5 py-3 border-b border-gray-800 flex items-center gap-2">
                <i class="fa-solid fa-water text-blue-500 text-xs"></i>
            ...
            <div class="overflow-y-auto max-h-96">
                <table class="w-full text-xs">
                    ...
                    <tbody id="tbl-renang-putra" class="divide-y divide-gray-900">
                    ...
                    <tbody id="tbl-renang-putri" class="divide-y divide-gray-900" style="display:none">
...
function showGender(gender) {
    const items = ['lari','pushup','situp','pullup','shuttle','renang'];
    items.forEach(item => {
        document.getElementById(`tbl-${item}-putra`).style.display = gender === 'putra' ? '' : 'none';
        document.getElementById(`tbl-${item}-putri`).style.display = gender === 'putri' ? '' : 'none';
    });

    document.getElementById('pullchin-title').textContent = gender === 'putra' ? 'Pull-Up' : 'Chin-Up';
    document.getElementById('tab-putra').className = gender === 'putra'
        ? 'px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-red-800 text-white'
        : 'px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-gray-900 border border-gray-800 text-gray-400 hover:text-white';
    document.getElementById('tab-putri').className = gender === 'putri'
        ? 'px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-red-800 text-white'
        : 'px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-gray-900 border border-gray-800 text-gray-400 hover:text-white';
}
</script>
